...
<div class="sidebar">
    ...
    <details>
        ...
        <div class="content">
            <a href="normalprofile.php">👤 Profile</a>
            <a href="normalpassword.php">🔑 Change Password</a>
        </div>
    </details>
    ...
    <details>
        ...
        <div class="content">
            <a href="normalevent.php">🚦Junction Event</a>
        </div>
    </details>
</div>
<style>
