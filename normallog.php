...
$total_records_query = mysqli_query($con, "SELECT COUNT(*) AS total FROM normaluserlog");
...
$query = mysqli_query($con, "SELECT * FROM normaluserlog ORDER BY id DESC LIMIT $offset, $records_per_page");
?>
